...
router.get('/getdata/:lookoutDataId/:userId',isSignedIn,isAuthenticated, getLookOutData);
router.get('/getalldata',getAllLookoutData);
router.post('/search/:userId',isSignedIn,isAuthenticated, findbyCrimeNumber);
